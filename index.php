...
<head>
    <meta charset="utf-8">
    <title>Waste-Grabber || Home Page</title>
...
{               ?>      
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">Waste Grabber</h2>
        </a>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome to Waste Grabber</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Cleaner Tomorrow Starts Today</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Trash/Garbage/Waste Pickup Scheduler Application.</p>
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome To Waste Grabber</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">A Next Step For Clean India</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Keep Your Surrounding Clean For The clean future.</p>
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome To Waste Grabber</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Makes Easy your Life To keep Clean Environment</h1>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Waste Grabber</a>, All Right Reserved.
                    </div>
